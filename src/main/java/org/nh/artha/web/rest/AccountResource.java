...
import org.nh.artha.service.MailService;
import org.nh.artha.service.RoleService;
import org.nh.artha.service.UserService;
import org.nh.artha.service.dto.PasswordChangeDTO;
import org.nh.artha.service.dto.UserDTO;
import org.nh.artha.web.rest.errors.*;
import org.nh.artha.web.rest.vm.KeyAndPasswordVM;
import org.nh.artha.web.rest.vm.ManagedUserVM;
...
public class AccountResource {
    ...
    public AccountResource(UserRepository userRepository, UserService userService, MailService mailService,
                           UserOrganizationRoleMappingRepository userOrganizationRoleMappingRepository,RoleService roleService) {
    ...
    public UserDTO getAccount() {
        ...
        try {
            Set<String> grantedAuthorities = userDTO.getAuthorities();
            Set<Privilege> privileges = new HashSet<Privilege>();
            Preferences preferences = UserPreferencesUtils.getCurrentUserPreferences();
            org.nh.artha.security.dto.User user = UserPreferencesUtils.getCurrentUserPreferences().getUser();
            ...
            privileges.spliterator().forEachRemaining(privilege -> {
                if (privilege.isActive()) {
                    grantedAuthorities.add(privilege.getCode());
                }
            });
