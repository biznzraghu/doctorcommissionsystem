...
@RestController
@RequestMapping("/api/artha-kafka")
public class ArthaKafkaResource {

    private final Logger log = LoggerFactory.getLogger(ArthaKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public ArthaKafkaResource(KafkaProperties kafkaProperties) {
