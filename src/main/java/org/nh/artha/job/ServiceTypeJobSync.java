...
public class ServiceTypeJobSync implements Job {
    private final Logger log = LoggerFactory.getLogger(ServiceTypeJobSync.class);
    ...
    public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
        ...
        String valueSetQuery="select * from value_set  where code ='SERVICE_TYPE'";
