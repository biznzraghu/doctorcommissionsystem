...
import { PayoutStatusClassMap } from 'app/entities/artha-models/status.enum';
import { PreferenceService } from 'app/artha-helpers/services/preference.service';

@Component({
  selector: 'jhi-change-requests-tab-list',
  templateUrl: './change-requests-tab.component.html'
})
export class ChangeRequestsTabListComponent implements OnInit, OnChanges {
