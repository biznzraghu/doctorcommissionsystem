...
public class DepartmentResourceIT {
     ...
     *
     * @see org.nh.artha.repository.search.DepartmentSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void setup() {
        ...
        final DepartmentResource departmentResource = new DepartmentResource(departmentService,departmentRepository,departmentSearchRepository,applicationProperties);
